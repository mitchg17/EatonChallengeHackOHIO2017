package com.employeesofreality.eatonnameplaterecognition.ui.camera;
...
public class OcrGraphic extends GraphicOverlay.Graphic implements Comparable{
    ...
    private static final int FILL_COLOR = 0x334292f4;
    ...
    OcrGraphic(GraphicOverlay overlay, TextBlock text) {
        ...
        if (sRectPaint == null) {
            ...
            sRectPaint.setColor(FILL_COLOR);
        ...
        if (sTextPaint == null) {
            ...
            sTextPaint.setColor(FILL_COLOR);
